...
# Apache 2.0.
if [ $# -le 0 ]; then
    echo "Argument should be the Timit directory."
    exit 1;
fi
...
if $uppercased; then
    ...
    ls -d "$1"/TEST/DR*/* | sed -e "s:^.*/::" > $tmpdir/test_spk
...
for x in train test; do
    ...
    then
        ...
        find $1/{$train_dir,$test_dir} -iname '*.PHN' \
    ...
    then
        ...
        find $1/{$train_dir,$test_dir} -iname '*.WRD' \
