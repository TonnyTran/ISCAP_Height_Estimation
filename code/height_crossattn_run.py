...
from modules_height.data_module_height_crossattn import Data_Module_height_crossattn
from modules_height.model_lstm_crossattn import lstm_crossattn

if __name__ == '__main__':      
    print(">>>>>> Model 1: LSTM + Cross_Attention + MSE_Loss | FBank Features | Height Estimation <<<<<<")
    ...
    csv_logger = CSVLogger('exp/', name='height_crossattn', version='4') # Creates a CSV in the folder which contains all the logs (Training + Testing + Validation)
    ...
    dm = Data_Module_height_crossattn(
